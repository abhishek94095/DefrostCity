Shader "WBGB/Lit/Dye/DiffDye6 Norm ISA Hue" 
{
    Properties
    {
        [NoScaleOffset]
        ...
        [NoScaleOffset]
        _IridSmoothAOGlowTex("Iridescence (R), Smoothness (G), Ambient Occlusion (B), Glow (A)", 2D) = "white" {}
        [NoScaleOffset]
        ...
        [NoScaleOffset]
        _IridTex("Iridescence Ramp (RGB)", 2D) = "white" {}
        _IridTexHueAdjust("Iridescence Hue Adjust", Range(0, 1)) = 0
        _IridFresnelPower("Iridescence Fresnel Power", Range(0,3)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D(_IridSmoothAOGlowTex);
            SAMPLER(sampler_IridSmoothAOGlowTex);
            ...
            uniform half _IridTexHueAdjust;
            uniform half _IridFresnelPower;
            ...
            half4 frag(VertexOutput IN) : COLOR
            {
                ...
                half4 isa = SAMPLE_TEXTURE2D(_IridSmoothAOGlowTex, sampler_IridSmoothAOGlowTex, IN.uv).rgba;
                ...
                //Fresnel & Irid
                half fresnel = Fresnel(normal, IN.normalWS, IN.positionWS, _IridFresnelPower);
                half3 irid = Irid(isa.r, fresnel, _IridTexHueAdjust);
                color = ApplyColorIrid(color, irid, fresnel);
                ...
                surfaceData.metallic = irid.x * fresnel;
                surfaceData.smoothness = isa.g;
                surfaceData.occlusion = isa.b;
                surfaceData.emission = isa.a * _EmissionColor.rgb * _EmissionIntensity;
